...
_Dernière mise à jour : 23/08/2026 — Branche `specs/important-features` : refonte complète du portail recruteur livrée de bout en bout — sidebar (Phase 1), modèle Paliers + admin (Phase 2a), gating réel (Phase 2b), les 9 pages sidebar dont Abonnements & Facturation, paiement Chargily réel pour les 4 paliers, résiliation, factures PDF. Voir sections ci-dessous._
