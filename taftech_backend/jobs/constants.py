...
SYNONYMES_SPECIALITE = {
    "IT": ["informatique", "technologie", "numérique", "digital", "développement", "software", "système", "réseau", "tech"],
    "FINANCE": ["comptabilité", "finance", "gestion", "audit", "fiscalité", "banque", "économie", "contrôle de gestion"],
    "RH": ["ressources humaines", "recrutement", "paie", "formation", "gestion du personnel", "rh"],
    "MARKETING": ["marketing", "communication", "publicité", "commercial", "vente", "digital marketing"],
    "JURIDIQUE": ["droit", "juridique", "légal", "notariat", "avocat", "juriste"],
    "SANTE": ["médecine", "santé", "pharmacie", "infirmier", "médical", "paramédical"],
    "EDUCATION": ["enseignement", "éducation", "formation", "pédagogie", "professeur"],
    "INGENIERIE": ["ingénierie", "génie civil", "mécanique", "électrique", "industriel", "btp"],
    "PRODUCTION": ["production", "industrie", "fabrication", "qualité", "logistique", "supply chain"],
    "ADMINISTRATION": ["administration", "secrétariat", "bureautique", "office management"],
}
