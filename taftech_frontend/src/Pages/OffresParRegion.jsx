      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-8">
          ...
          <p className="text-sm text-slate-500">
            Sélectionnez votre wilaya pour voir les postes disponibles près de
            chez vous.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
              {wilayas.map((wilaya, index) => (
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-indigo-50 hover:text-indigo-700 text-slate-700 transition-colors group"
                >
                  <MapPin
                    size={14}
                    className="text-slate-400 group-hover:text-indigo-500 flex-shrink-0"
                  />
                  <span className="text-sm font-medium">{wilaya.label}</span>
                </Link>
              ))}
            </div>
          </div>
